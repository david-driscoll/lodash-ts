...
result = <(key: string, value: any) => { [index: string]: any }>testMapCache.set;
...
module TestDropRightWhile {
    let array: TResult[];
    let list: ArrayLike<TResult>;
    let predicateFn: (value: TResult, index: number, collection: ArrayLike<TResult>) => boolean;
...
module TestFill {
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<ArrayLike<number>>;
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<ArrayLike<number>>;
...
module TestLast {
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<ArrayLike<TResult>>;

        result = _(list).chain().last<ArrayLike<TResult>>();
    }
}
...
module TestPull {
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<ArrayLike<TResult>>;
...
module TestUniq {
    ...
    let listIterator: (value: SampleObject, index: number, collection: ArrayLike<SampleObject>) => number;
...
// _.unzipWith
{
    let testUnzipWithArray: (number[]|ArrayLike<number>)[];
    let testUnzipWithList: ArrayLike<number[]|ArrayLike<number>>;
...
module TestZipObject {
    ...
    let listOfKeyValuePairs: ArrayLike<ArrayLike<string|number>>;

    {
        let result: { [index: string]: void };

        result = _.zipObject<{ [index: string]: void }>(arrayOfKeys);
        result = _.zipObject<{ [index: string]: void }>(listOfKeys);
    }

    {
        let result: { [index: string]: number };

        result = _.zipObject<{ [index: string]: number }>(arrayOfKeys, arrayOfValues);
        result = _.zipObject<{ [index: string]: number }>(arrayOfKeys, listOfValues);
        result = _.zipObject<{ [index: string]: number }>(listOfKeys, listOfValues);
        result = _.zipObject<{ [index: string]: number }>(listOfKeys, arrayOfValues);

        result = _.zipObject<number, { [index: string]: number }>(arrayOfKeys, arrayOfValues);
        result = _.zipObject<number, { [index: string]: number }>(arrayOfKeys, listOfValues);
        result = _.zipObject<number, { [index: string]: number }>(listOfKeys, listOfValues);
        result = _.zipObject<number, { [index: string]: number }>(listOfKeys, arrayOfValues);

        result = _.zipObject<{ [index: string]: number }>(arrayOfKeyValuePairs);
        result = _.zipObject<{ [index: string]: number }>(listOfKeyValuePairs);
    }
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<{ [index: string]: void }>;

        result = _(arrayOfKeys).zipObject<{ [index: string]: void }>();
        result = _(listOfKeys).zipObject<{ [index: string]: void }>();
    }

    {
        let result: _.LoDashImplicitObjectWrapper<{ [index: string]: number }>;

        result = _(arrayOfKeys).zipObject<{ [index: string]: number }>(arrayOfValues);
        result = _(arrayOfKeys).zipObject<{ [index: string]: number }>(listOfValues);
        result = _(listOfKeys).zipObject<{ [index: string]: number }>(listOfValues);
        result = _(listOfKeys).zipObject<{ [index: string]: number }>(arrayOfValues);

        result = _(arrayOfKeys).zipObject<number, { [index: string]: number }>(arrayOfValues);
        result = _(arrayOfKeys).zipObject<number, { [index: string]: number }>(listOfValues);
        result = _(listOfKeys).zipObject<number, { [index: string]: number }>(listOfValues);
        result = _(listOfKeys).zipObject<number, { [index: string]: number }>(arrayOfValues);

        result = _(listOfKeys).zipObject<{ [index: string]: number }>(arrayOfKeyValuePairs);
        result = _(listOfKeys).zipObject<{ [index: string]: number }>(listOfKeyValuePairs);
    }

    {
        let result: _.LoDashImplicitObjectWrapper<{ [index: string]: any }>;
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<{ [index: string]: void }>;

        result = _(arrayOfKeys).chain().zipObject<{ [index: string]: void }>();
        result = _(listOfKeys).chain().zipObject<{ [index: string]: void }>();
    }

    {
        let result: _.LoDashExplicitObjectWrapper<{ [index: string]: number }>;

        result = _(arrayOfKeys).chain().zipObject<{ [index: string]: number }>(arrayOfValues);
        result = _(arrayOfKeys).chain().zipObject<{ [index: string]: number }>(listOfValues);
        result = _(listOfKeys).chain().zipObject<{ [index: string]: number }>(listOfValues);
        result = _(listOfKeys).chain().zipObject<{ [index: string]: number }>(arrayOfValues);

        result = _(arrayOfKeys).chain().zipObject<number, { [index: string]: number }>(arrayOfValues);
        result = _(arrayOfKeys).chain().zipObject<number, { [index: string]: number }>(listOfValues);
        result = _(listOfKeys).chain().zipObject<number, { [index: string]: number }>(listOfValues);
        result = _(listOfKeys).chain().zipObject<number, { [index: string]: number }>(arrayOfValues);

        result = _(listOfKeys).chain().zipObject<{ [index: string]: number }>(arrayOfKeyValuePairs);
        result = _(listOfKeys).chain().zipObject<{ [index: string]: number }>(listOfKeyValuePairs);
    }

    {
        let result: _.LoDashExplicitObjectWrapper<{ [index: string]: any }>;
...
module TestAt {
    let array: TResult[];
    let list: ArrayLike<TResult>;
    let dictionary: { [index: string]: TResult };
...
module TestCountBy {
    ...
    let listIterator: (value: TResult, index: number, collection: ArrayLike<TResult>) => any;
    let dictionaryIterator: (value: TResult, key: string, collection: { [index: string]: TResult }) => any;
    ...
    {
        let resutl: _.LoDashImplicitObjectWrapper<{ [index: string]: number }>;
    ...
    {
        let resutl: _.LoDashExplicitObjectWrapper<{ [index: string]: number }>;
...
module TestEach {
    ...
    {
        let result: { [index: string]: TResult };
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<{ [index: string]: TResult }>;
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<{ [index: string]: TResult }>;
...
namespace TestEvery {
    ...
    let array: SampleObject[];
    let list: ArrayLike<SampleObject>;
    let dictionary: { [index: string]: SampleObject };
    let numericDictionary: _.NumericDictionary<SampleObject>;

    let listIterator: (value: SampleObject, index: number, collection: ArrayLike<SampleObject>) => boolean;
    let dictionaryIterator: (value: SampleObject, key: string, collection: { [index: string]: SampleObject }) => boolean;
...
module TestFind {
    ...
    let listIterator: (value: TResult, index: number, collection: ArrayLike<TResult>) => boolean;
    let dictionaryIterator: (value: TResult, key: string, collection: { [index: string]: TResult }) => boolean;
...
module TestGroupBy {
    ...
    let array: SampleType[];
    let list: ArrayLike<SampleType>;
    let dictionary: { [index: string]: SampleType };

    let stringIterator: (char: string, index: number, string: string) => number;
    let listIterator: (value: SampleType, index: number, collection: ArrayLike<SampleType>) => number;
    let dictionaryIterator: (value: SampleType, key: string, collection: { [index: string]: SampleType }) => number;
    ...
    {
        let result: { [index: string]: SampleType[] };
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<{ [index: string]: string[] }>;
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<{ [index: string]: SampleType[] }>;
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<{ [index: string]: string[] }>;
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<{ [index: string]: SampleType[] }>;
...
module TestKeyBy {
    ...
    let stringIterator: (value: string, index: number, collection: string) => any;
    let listIterator: (value: SampleObject, index: number, collection: ArrayLike<SampleObject>) => any;
    let dictionaryIterator: (value: SampleObject, key: string, collection: { [index: string]: SampleObject }) => any;
    ...
    {
        let result: { [index: string]: SampleObject };
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<{ [index: string]: SampleObject }>;
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<{ [index: string]: SampleObject }>;
...
module TestInvokeMap {
    ...
    let numDict: { [index: string]: number } = {
        a: 1,
        b: 2,
        c: 3,
        d: 4
...
module TestMap {
    ...
    let listIterator: (value: number, index: number, collection: ArrayLike<number>) => TResult;
    let dictionaryIterator: (value: number, key: string, collection: { [index: string]: number }) => TResult;
...
module TestSortBy {
    ...
    let listIterator: (value: TResult, index: number, collection: ArrayLike<TResult>) => number;
    let dictionaryIterator: (value: TResult, key: string, collection: { [index: string]: TResult }) => number;
...
module TestMaxBy {
    ...
    let listIterator: (value: number, index: number, collection: ArrayLike<number>) => number;
    let dictionaryIterator: (value: number, key: string, collection: { [index: string]: number }) => number;
...
module TestFindKey {
    ...
    {
        let predicateFn: (value: string, key?: string, collection?: { [index: string]: string }) => boolean;
        let result: string;
...
module TestMapKeys {
    ...
    let listIterator: (value: TResult, index: number, collection: ArrayLike<TResult>) => string;
    let dictionaryIterator: (value: TResult, key: string, collection: { [index: string]: TResult }) => string;
...
namespace TestToPairs {
...

    {
        ...
        result = _.toPairs<{ [index: string]: string }>(object);
    }

    {
        let result: string[][];

        result = _.toPairs<{ [index: string]: string }, string>(object);
    }
...
namespace TestToPairsIn {
...

    {
        ...
        result = _.toPairsIn<{ [index: string]: string }>(object);
    }

    {
        let result: string[][];

        result = _.toPairsIn<{ [index: string]: string }, string>(object);
    }
...
module TestTransform {
    ...
    {
        let iterator: (acc: { [index: string]: TResult }, curr: number, index?: number, arr?: number[]) => void;
        let accumulator: { [index: string]: TResult };
        let result: { [index: string]: TResult };
    ...
    {
        let iterator: (acc: { [index: string]: TResult }, curr: number, key?: string, dict?: { [index: string]: number }) => void;
        let accumulator: { [index: string]: TResult };
        let result: { [index: string]: TResult };
    ...
    {
        let iterator: (acc: TResult[], curr: number, key?: string, dict?: { [index: string]: number }) => void;
        let accumulator: TResult[];
        let result: TResult[];
...
// _.values
module TestValues {
    let object: { [index: string]: TResult };
...
// _.mixin
module TestMixin {
    let source: { [index: string]: Function };
